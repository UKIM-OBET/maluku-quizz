...
<div class="flex items-center justify-between flex-wrap gap-3 mb-8">
    <div>
        ...
        <p class="text-gray-600 m-0">Dashboard Guru - Kelola & Pantau Pembelajaran Budaya</p>
    </div>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    <div class="card-engage bg-gradient-to-br from-[#EBF5F0] to-white rounded-3xl p-6 shadow-md border-l-4 border-[#0B6B63]">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-sm text-gray-600 m-0">Total Materi Budaya</p>
                <h3 class="text-3xl font-bold text-[#0B6B63] m-0">{{ $cultures }}</h3>
                <p class="text-xs text-gray-500 m-0 mt-1">Topik pembelajaran</p>
            </div>
    ...
    <div class="card-engage bg-gradient-to-br from-[#FFE4D4] to-white rounded-3xl p-6 shadow-md border-l-4 border-[#FF6B35]">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-sm text-gray-600 m-0">Kuis Tersedia</p>
    ...
    <div class="card-engage bg-gradient-to-br from-[#E8F4F1] to-white rounded-3xl p-6 shadow-md border-l-4 border-[#2F9E96]">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-sm text-gray-600 m-0">Siswa Aktif</p>
                <h3 class="text-3xl font-bold text-[#2F9E96] m-0">{{ $students ?? '0' }}</h3>
                <p class="text-xs text-gray-500 m-0 mt-1">Mengikuti pembelajaran</p>
            </div>
            <div class="text-5xl">👨‍🎓</div>
        </div>
    </div>
...
<div class="mb-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <a href="https://www.google.com/search?q=Topi+Adat+Maluku+tradisional" target="_blank" rel="noopener noreferrer" class="card-engage bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 list-item no-underline">
            <div class="bg-gradient-to-br from-[#FF6B35] to-[#FF8555] h-40 flex items-center justify-center text-6xl hover:scale-110 transition-transform duration-300">
                🎩
            </div>
            <div class="p-4">
...
<div class="mb-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <a href="https://www.google.com/search?q=Burung+Cendrawasih+Maluku+fauna" target="_blank" rel="noopener noreferrer" class="card-engage bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 list-item no-underline">
        ...
        <a href="https://www.google.com/search?q=Komodo+reptil+endemik+Indonesia" target="_blank" rel="noopener noreferrer" class="card-engage bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 list-item no-underline">
            <div class="bg-gradient-to-br from-[#0B6B63] to-[#2F9E96] h-40 flex items-center justify-center text-6xl hover:scale-110 transition-transform duration-300">
                🦎
            </div>
            <div class="p-4">
...
<div class="text-center bg-gradient-to-r from-[#0B6B63] to-[#2F9E96] text-white rounded-3xl p-8 mb-6">
    <p class="text-lg font-semibold m-0 mb-2">🎓 Mengajarkan Kekayaan Budaya Maluku Tengah</p>
    <p class="text-sm m-0">Melalui pameran interaktif, pembelajaran menjadi lebih menarik dan bermakna</p>
</div>
@endsection
